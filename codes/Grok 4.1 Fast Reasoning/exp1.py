...
class PuMVRGrokEvaluator:
    """
    Evaluator class for xAI Grok models on PuMVR dataset.
    """
    ...
    def __init__(
        ...
        self.output_dir = output_dir or f"./results_grok_{safe_model_name}"
    ...
    def _get_csv_path(self, script: str) -> str:
        filename = f"res_grok_{script}.csv"
    ...
    def run(self) -> Dict[str, Any]:
        print("=" * 60)
        print(f"PuMVR Evaluator (Grok API) | Model: {self.model_id}")
        print("=" * 60)
...
if __name__ == "__main__":
    ...
    evaluator = PuMVRGrokEvaluator(
        model_id=model_name,
        batch_size=375,
        output_dir="./results_grok_exp1"
    )
    evaluator.run()
